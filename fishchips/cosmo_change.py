...
class Observables:
    ...
    def get_cosmo(self, classy_dict): #not necessary
        """
    ...
    def compute_cosmo(self, key, classy_dict): #not necessary
        """
    ...
    def grid_cosmo(self, parameter, parameter_grid, classy_dict, verbose=False): #not necessary
        """
